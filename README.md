## rosfmt (noetic) - 8.0.0-1

The packages in the `rosfmt` repository were released into the `noetic` distro by running `/usr/bin/bloom-release --ros-distro noetic rosfmt` on `Mon, 10 Jul 2023 12:31:49 -0000`
